function createSwiper(
  ...
  return /* html */ `
    ...
    <div class="swiper-slide">
      <div class="container-general">
        <div class="gallery-wrap wrap-effect-4">
          <div class="item"></div>
          <div class="item"></div>
          <div class="item"></div>
          <div class="item"></div>
...
<defs>
  <clipPath id="ldio-sfnoseuswpb-cp">
...
<g id="ldio-sfnoseuswpb-rainbow" clip-path="url(#ldio-sfnoseuswpb-cp)">
...
export function renderSwiper(target) {
  insertLast(target, createSwiper());
}
